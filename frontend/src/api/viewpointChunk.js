 ...
 * @param {number} itemId - 观点条目ID
 * @returns {Promise<Array>} Chunk列表
 */
export const fetchChunks = async (projectId, itemId) => {
  const response = await apiClient.get(`/projects/${projectId}/viewpoint-items/${itemId}/chunks`);
  return response;
};
...
export const createChunk = async (projectId, itemId, title, content) => {
  const response = await apiClient.post(`/projects/${projectId}/viewpoint-items/${itemId}/chunks`, {
    title,
    content,
  });
  return response;
...
export const updateChunk = async (chunkId, title, content) => {
  const response = await apiClient.put(`/viewpoint-chunks/${chunkId}`, {
    title,
    content,
  });
  return response;
...
export const deleteChunk = async (chunkId) => {
  const response = await apiClient.delete(`/viewpoint-chunks/${chunkId}`);
  return response;
};
...
export const reorderChunks = async (projectId, itemId, chunkOrders) => {
  const response = await apiClient.put(`/projects/${projectId}/viewpoint-items/${itemId}/chunks/reorder`, {
